...
function Sivan(props) {
  const { pathname } = useLocation();
  const history = useHistory();

  const [categories, setCategories] = useState("Sivan Parvathi");
...
export default withRouter(
  connect(mapStateToProps, mapDispatchToProps)(Sivan)
);
