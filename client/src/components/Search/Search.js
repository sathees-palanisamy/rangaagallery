...
const Search = (props) => {
    ...
    const findImagePrice = (cate,startingSize) => {
     ...
     if (cate === 'Y') {
      return props.PichwaiWallRateExt[startingSize - 1].amount;
     }
  
     if (cate === 'W') {
      return props.MuralWallRateExt[startingSize - 1].amount;
     }

     if (cate === 'A') {
      return props.squareMukkRateExt[startingSize - 1].amount;
     }
    ...
    if (props.rendersearchText.length > 0) {
           ...
           productList = props.rendersearchText.map((indiProduct,d1) => {
           ...
           return  <div className="css-photo-border " key={d1}>
            ...
            productList =      <div className="css-photos-cover css-flex-space ">
            <div className="css-lay-cart-empty css-flex-space">
              <img alt="empty cart" className="css-image-dis-cor " src="assets/mis/no-product-found-x.png"/>
